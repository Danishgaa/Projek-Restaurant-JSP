<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    <section class="menu">
        ...
        <div>
            <center>
                <img src="https://www.frisianflag.com/storage/app/media/uploaded-files/pecel-sayur-sederhana.jpg"
            ...
            <form action="menu" method="Post">
                ...
                %>
                <input type="hidden" class="form-control"  name="nama_makanan" value="Pecel">
