<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    <section class="menu">
        ...
        <div>
            <center>
                <img src="https://kbu-cdn.com/dk/wp-content/uploads/otak-otak-goreng-ala-kobe.jpg"
            ...
            <form action="menu" method="Post">
                ...
                %>
                <input type="hidden" class="form-control"  name="nama_makanan" value="Otak otak">
                <input type="hidden" class="form-control"  name="id_user" value="<%=id_user%>">
                <!--Isi Value sesuai Dengan harga-->
                                <input type="hidden" class="form-control"  name="harga" value="10000">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <select name="rasa" class="form-control"required>
                            <option disabled="disabled">-- Saus --</option>
                            <option value="Original">Original</option>
                            <option value="Madu">Madu</option>
                            <option value="Manis">Pedes</option>
