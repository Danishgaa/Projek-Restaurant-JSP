<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    <link rel="stylesheet" href="style.css">
     ...
     <section class="menu">
        ...
        <div>
            <center>
                <img src="https://i0.wp.com/resepkoki.id/wp-content/uploads/2017/02/Resep-Gado-Gado.jpg?fit=1920%2C1840&ssl=1"
                ...
                %>
                <input type="hidden" class="form-control"  name="nama_makanan" value="Gado Gado">
                <input type="hidden" class="form-control"  name="id_user" value="<%=id_user%>">
                <!--Isi Value sesuai Dengan harga-->
                                <input type="hidden" class="form-control"  name="harga" value="18000">
