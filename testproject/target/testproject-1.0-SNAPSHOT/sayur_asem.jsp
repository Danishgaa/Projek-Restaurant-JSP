...
<body>
    ...
    <section class="menu">
        ...
        <div>
            <center>
                <img src="https://img.kurio.network/nxXnNSatVIgp1b8Eqpfd4DI53lg=/1200x900/filters:quality(80)/https://kurio-img.kurioapps.com/21/06/14/5e8d8c4b-156a-4847-bfac-f1f17a60d203.jpe"
            ...
            <form action="menu" method="Post">
                ...
                %>
                <input type="hidden" class="form-control"  name="nama_makanan" value="sayur Asem">
                <input type="hidden" class="form-control"  name="id_user" value="<%=id_user%>">
                <!--Isi Value sesuai Dengan harga-->
                                <input type="hidden" class="form-control"  name="harga" value="11000">
                <div class="mb-3">
