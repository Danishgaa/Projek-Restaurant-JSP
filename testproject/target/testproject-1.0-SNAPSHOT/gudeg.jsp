...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 ...
 <%@include file="header.jsp" %>
     ...
     <section class="menu">
        ...
        <div>
            <center>
                <img src="https://img-global.cpcdn.com/recipes/a8d0ffc50429e676/400x400cq70/photo.jpg"
                ...
                %>
                <input type="hidden" class="form-control"  name="nama_makanan" value="Gudeg">
                <input type="hidden" class="form-control"  name="id_user" value="<%=id_user%>">
                <!--Isi Value sesuai Dengan harga-->
                                <input type="hidden" class="form-control"  name="harga" value="14000">
