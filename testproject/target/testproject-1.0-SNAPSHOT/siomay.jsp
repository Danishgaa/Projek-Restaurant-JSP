<%@page contentType="text/html" pageEncoding="UTF-8"%>
  ...
  <%@include file="header.jsp" %>
    ...
    <section class="menu">
        ...
        <div>
            <center>
                <img src="https://asset.kompas.com/crops/Atp1STR6jMcegrNX0anTx5eN7xY=/0x0:1000x667/780x390/data/photo/2021/05/23/60aa371ed27a5.jpg"
            ...
            <form action="menu" method="Post">
                ...
                %>
                <input type="hidden" class="form-control"  name="nama_makanan" value="Siomay">
                <input type="hidden" class="form-control"  name="id_user" value="<%=id_user%>">
                <!--Isi Value sesuai Dengan harga-->
                                <input type="hidden" class="form-control"  name="harga" value="12000">
                <div class="mb-3">
