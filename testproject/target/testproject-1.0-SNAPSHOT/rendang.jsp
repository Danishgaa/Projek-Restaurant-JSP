...
<head>
    ...
    <title>Restaurant Nusantara || Nusa Food || Menu</title>
...
<body>
    ...
    <section class="menu">
        ...
        <div>
            <center>
                <img src="https://cdn0-production-images-kly.akamaized.net/9epGjc5IstDbBLSmoTRTuRabzU4=/1x112:1000x675/673x379/filters:quality(75):strip_icc():format(webp)/kly-media-production/medias/3245094/original/043061400_1600750232-shutterstock_1786027046.jpg"
                    width="500" height="375" border="10">
                <br>
            ...
            <form action="menu" method="Post">
                ...
                %>
                <input type="hidden" class="form-control"  name="nama_makanan" value="Rendang">
