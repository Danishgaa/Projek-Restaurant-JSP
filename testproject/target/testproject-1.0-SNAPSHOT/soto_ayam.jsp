<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    <section class="menu">
        ...
        <div>
            <center>
                <img src="https://blog.sayurbox.com/wp-content/uploads/2020/06/yusrisalaprianti.jpg"
            ...
            <form action="menu" method="Post">
                ...
                %>
                <input type="hidden" class="form-control"  name="nama_makanan" value="Soto Ayam">
                <input type="hidden" class="form-control"  name="id_user" value="<%=id_user%>">
                <!--Isi Value sesuai Dengan harga-->
                                <input type="hidden" class="form-control"  name="harga" value="16000">
                <div class="mb-3">
